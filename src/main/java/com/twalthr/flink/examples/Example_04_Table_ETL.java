...
public class Example_04_Table_ETL {
  ...
  public static void main(String[] args) throws Exception {
    ...
    /*
    Beispiel wir in 03_DatStream
    T. Walter findet diese API "more concise"
    es können viele built in functions genutzt werden
    ...
    final Table t =
        env.fromValues(
            ...
            .select(
                    //a jsonObject function (seit 1.15)
                    //auf currentDate kann als builtIn Function zugegriffen werden
                    //basically the expressions are built with the expression API
                jsonObject(
                    JsonOnNull.NULL,
                    "name",
                    $("c_name"),
