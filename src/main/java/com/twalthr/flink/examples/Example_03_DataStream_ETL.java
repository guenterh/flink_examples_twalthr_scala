...
public class Example_03_DataStream_ETL {
  ...
  public static void main(String[] args) throws Exception {
    ...
    /*
    häufig möchten wir ETL processors einsetzen
    wie wird ETL in DataStream eingesetzt?
    Annahme: wir möchten unsere customer pojos in json data umwandeln
    in der DataStream API kann jede dependency die wir wünschen eingesetzt werden
